...
use Illuminate\Http\Request;
	...
	public function com202021_conslttn_ttndnc_pctre_consultation_attendence_blb_create(Request $request)
	{
		...
		$response = DB::table("aggregate.COM202021_CONSLTTN_TTNDNC_PCTRE_CONSULTATION_ATTENDENCE_BLB")->insert($data);
		return response()->json($response);
	}


	public function com202021_conslttn_ttndnc_pctre_consultation_attendence_blb_bulk_create(Request $request)
	{
	...
	public function com202021_conslttn_ttndnc_pctre_consultation_attendence_blb_tlauri($tlauri)
	{
		...
		$sql = "
            select
                gen.*
                from 
                aggregate.\"COM202021_CONSLTTN_TTNDNC_PCTRE_CONSULTATION_ATTENDENCE_BLB\" as gen
	...
	public function com202021_conslttn_ttndnc_pctre_consultation_attendence_blb_delete($uri, $auri)
	{
		$deleted = DB::table("aggregate.COM202021_CONSLTTN_TTNDNC_PCTRE_CONSULTATION_ATTENDENCE_BLB")
	...
	public function com202021_conslttn_ttndnc_pctre_consultation_attendence_blb_update(Request $request, $auri)
	{
		DB::table('aggregate.COM202021_CONSLTTN_TTNDNC_PCTRE_CONSULTATION_ATTENDENCE_BLB')
	...
	public function com202021_conslttn_ttndnc_pctre_consultation_attendence_blb_delete_all()
	{
		DB::table('aggregate.COM202021_CONSLTTN_TTNDNC_PCTRE_CONSULTATION_ATTENDENCE_BLB')->delete();
