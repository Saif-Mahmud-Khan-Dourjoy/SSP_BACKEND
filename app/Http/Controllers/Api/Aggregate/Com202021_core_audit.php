<?php
	...
	class Com202021_core_audit extends Controller
	{
		
		public function com202021_core_audit_create(){
			$data = array(
				"id" => Request::input("id"),
...
"AdditionTime" => Request::input("additiontime"),

			);
			$insert_id = DB::table("COM202021_CORE_AUDIT")->insertGetId($data);
			return response()->json($insert_id);
		}
		public function com202021_core_audit_list(){
			$query = DB::select('select * from aggregate."COM202021_CORE_AUDIT"');
