...
class Plant27_2021_overallnotes_ima_blb extends Controller
{

	public function plant27_2021_overallnotes_ima_blb_create(Request $request)
	{
		...
		$response = DB::table("aggregate.PLANT27_2021_OVERALLNOTES_IMA_BLB")->insert($data);
		return response()->json($response);
	}
	public function plant27_2021_overallnotes_ima_blb_list()
	{
		$query = DB::select('select * from aggregate."PLANT27_2021_OVERALLNOTES_IMA_BLB"');
		$r = array();
	...
	public function plant27_2021_overallnotes_ima_blb_update(Request $request, $tlauri)
	{
		DB::table('aggregate.PLANT27_2021_OVERALLNOTES_IMA_BLB')
	...
	public function plant27_2021_overallnotes_ima_blb_tlauri($tlauri)
	{
		...
		$sql = "
            select
                gen.*
                from 
                aggregate.\"PLANT27_2021_OVERALLNOTES_IMA_BLB\" as gen
