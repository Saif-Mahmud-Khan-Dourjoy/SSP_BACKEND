...
class Plant27_2021_xpictureextra_ref extends Controller
{

	public function plant27_2021_xpictureextra_ref_create()
	{
		$data = array(
		...
		$insert_id = DB::table("PLANT27_2021_XPICTUREEXTRA_REF")->insertGetId($data);
		return response()->json($insert_id);
	}

	public function plant27_2021_xpictureextra_ref_list()
	{
		$query = DB::select('select * from aggregate."PLANT27_2021_XPICTUREEXTRA_REF"');
		return response()->json($query);
	}

	public function plant27_2021_xpictureextra_ref_update(Request $request, $tlauri)
	{
		DB::table('aggregate.PLANT27_2021_XPICTUREEXTRA_REF')
		...
		$response = DB::table("aggregate.PLANT27_2021_XPICTUREEXTRA_REF")->insert($data);
