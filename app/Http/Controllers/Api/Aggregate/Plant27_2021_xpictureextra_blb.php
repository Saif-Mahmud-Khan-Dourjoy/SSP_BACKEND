<?php
	...
	class Plant27_2021_xpictureextra_blb extends Controller
	{
		...
		public function plant27_2021_xpictureextra_blb_create(){
			$data = array(
			...
			$insert_id = DB::table("PLANT27_2021_XPICTUREEXTRA_BLB")->insertGetId($data);
			return response()->json($insert_id);
		}
		public function plant27_2021_xpictureextra_blb_list(){
			$query = DB::select('select * from aggregate."PLANT27_2021_XPICTUREEXTRA_BLB" limit 1');
			$r = array();			
