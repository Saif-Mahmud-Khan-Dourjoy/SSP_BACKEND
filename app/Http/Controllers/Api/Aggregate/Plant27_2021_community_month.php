...
class Plant27_2021_community_month extends Controller
{
	...
	public function plant27_2021_community_month_delete($uri, $tlauri)
	{
		$deleted = DB::table("aggregate.PLANT27_2021_COMMUNITY_MONTH")
	...
	public function plant27_2021_community_month_single_update(Request $request, $uri)
	{
		...
		$response = DB::table("aggregate.PLANT27_2021_COMMUNITY_MONTH")
		->where("_URI", $uri)
		->update($updatedData);
