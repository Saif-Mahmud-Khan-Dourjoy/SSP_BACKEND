...
class Com202021_consultation_picture_blb extends Controller
{

	public function com202021_consultation_picture_blb_create(Request $request)
	{
		...
		$response = DB::table("aggregate.COM202021_CONSULTATION_PICTURE_BLB")->insert($data);
		return response()->json($response);
	}


	public function com202021_consultation_picture_blb_bulk_create(Request $request)
	{
	...
	public function com202021_consultation_picture_blb_list()
	{
		$query = DB::select('select * from aggregate."COM202021_CONSULTATION_PICTURE_BLB"');
		$r = array();
	...
	public function com202021_consultation_picture_blb_tlauri($tlauri)
	{
		...
		$sql = "
            select
                gen.*
                from 
                aggregate.\"COM202021_CONSULTATION_PICTURE_BLB\" as gen
	...
	public function com202021_consultation_picture_blb_delete($uri, $auri)
	{
		$deleted = DB::table("aggregate.COM202021_CONSULTATION_PICTURE_BLB")
	...
	public function com202021_consultation_picture_blb_update(Request $request, $auri)
	{
		DB::table('aggregate.COM202021_CONSULTATION_PICTURE_BLB')
	...
	public function com202021_consultation_picture_blb_delete_all()
	{
		DB::table('aggregate.COM202021_CONSULTATION_PICTURE_BLB')->delete();
