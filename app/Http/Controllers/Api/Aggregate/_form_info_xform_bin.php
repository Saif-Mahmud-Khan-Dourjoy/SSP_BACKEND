<?php
	...
	class _form_info_xform_bin extends Controller
	{
		
		public function _form_info_xform_bin_create(){
			$data = array(
...
"CONTENT_HASH" => Request::input("content_hash"),
			...
			$insert_id = DB::table("_form_info_xform_bin")->insertGetId($data);
			return response()->json($insert_id);
		}
		public function _form_info_xform_bin_list(){
			$query = DB::select('select * from aggregate."_form_info_xform_bin"');
