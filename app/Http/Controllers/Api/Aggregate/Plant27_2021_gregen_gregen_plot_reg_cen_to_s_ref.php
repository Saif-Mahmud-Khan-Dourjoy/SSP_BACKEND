...
// 		}
	...
	public function plant27_2021_gregen_gregen_plot_reg_cen_to_s_ref_delete($uri, $tlauri)
	{
		$deleted = DB::table("aggregate.PLANT27_2021_GREGEN_GREGEN_PLOT_REG_CEN_TO_S_REF")
