<?php
	...
	class Sufal192020_rphotoextra extends Controller
	{
		
		public function sufal192020_rphotoextra_create(){
			$data = array(
...
"PPICLOCATIONEXTRA_LAT" => Request::input("ppiclocationextra_lat"),
			...
			$insert_id = DB::table("SUFAL192020_RPHOTOEXTRA")->insertGetId($data);
			return response()->json($insert_id);
		}
		public function sufal192020_rphotoextra_list(){
			$query = DB::select('select * from aggregate."SUFAL192020_RPHOTOEXTRA"');
