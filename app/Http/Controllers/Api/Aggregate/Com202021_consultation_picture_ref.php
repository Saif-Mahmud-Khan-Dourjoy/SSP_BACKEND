...
class Com202021_consultation_picture_ref extends Controller
{
	...
	public function com202021_consultation_picture_ref_create(Request $request)
	{
		$data = array(
		...
		$response = DB::table("aggregate.COM202021_CONSULTATION_PICTURE_REF")->insert($data);
	...
	public function com202021_consultation_picture_ref_update(Request $request, $tlauri)
	{
		DB::table('aggregate.COM202021_CONSULTATION_PICTURE_REF')
