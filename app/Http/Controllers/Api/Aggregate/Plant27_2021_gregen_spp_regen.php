...
class Plant27_2021_gregen_spp_regen extends Controller
{
	...
	public function plant27_2021_gregen_spp_regen_delete($uri, $tlauri)
	{
		$deleted = DB::table("aggregate.PLANT27_2021_GREGEN_SPP_REGEN")
	...
	public function plant27_2021_gregen_spp_regen_single_update(Request $request, $uri)
	{
		...
		$response = DB::table("aggregate.PLANT27_2021_GREGEN_SPP_REGEN")
			->where("_URI", $uri)
			->update($updatedData);
