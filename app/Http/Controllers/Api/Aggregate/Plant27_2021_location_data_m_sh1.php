...
use Illuminate\Http\Request;
	...
	public function plant27_2021_location_data_m_sh1_delete($uri, $tlauri)
	{
		$deleted = DB::table("aggregate.PLANT27_2021_LOCATION_DATA_M_SH1")
	...
	public function plant27_2021_location_data_m_sh1_single_update(Request $request, $uri)
	{
		...
		$response = DB::table("aggregate.PLANT27_2021_LOCATION_DATA_M_SH1")
		->where("_URI", $uri)
		->update($updatedData);
