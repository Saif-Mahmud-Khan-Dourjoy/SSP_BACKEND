...
use Illuminate\Http\Request;
	...
	public function plant27_2021_gregen_gregen_plot_reg_cen_to_n_ref_list()
	{
		$query = DB::select('select * from aggregate."PLANT27_2021_GREGEN_GREGEN_PLOT_REG_CEN_TO_N_REF"');
		return response()->json($query);
	}

	public function plant27_2021_gregen_gregen_plot_reg_cen_to_n_ref_tlauri($tlauri)
	{
		DB::EnableQueryLog();
		$sql = "
            select
                gen.*
                from 
                aggregate.\"PLANT27_2021_GREGEN_GREGEN_PLOT_REG_CEN_TO_N_REF\" as gen
	...
	public function plant27_2021_gregen_gregen_plot_reg_cen_to_n_ref_update(Request $request, $auri)
	{
