...
if (Request::input("token") == $token) {
	...
	Route::put('/plant27_2021_xpictureextra_ref_update/{tlauri}', '\App\Http\Controllers\Api\Aggregate\Plant27_2021_xpictureextra_ref@plant27_2021_xpictureextra_ref_update');
